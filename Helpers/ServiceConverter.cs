...
namespace inReachWebRebuild.Helpers
{
    ...
    {  /// <summary>
       ...
       /// </summary>
        ...
        {
            DocumentConverterUrl = SettingsManager.GetSettingValueAsString("files.docservice.url.converter")  ?? "";
            DocumentStorageUrl = SettingsManager.GetSettingValueAsString("files.docservice.url.storage") ?? "";

            Int32.TryParse(SettingsManager.GetSettingValueAsString("files.docservice.timeout") , out ConvertTimeout);
